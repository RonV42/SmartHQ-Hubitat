metadata {
    definition(
        name: "GE Profile Lower Oven",
        namespace: "RonV42",
        author: "Ron Vargo",
        description: "GE Profile Lower Oven via SmartHQ Bridge"
    ) {
        capability "Sensor"
        capability "Refresh"
...
def installed() {
    log.info "GE Profile Lower Oven installed"
    initialize()
}

def updated() {
    log.info "GE Profile Lower Oven updated"
    initialize()
}
